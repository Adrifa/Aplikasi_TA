                        ...
                        @foreach($pegawais as $pegawai)
                            <tr>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <form action="{{ route('gaji.destroy', $pegawai->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{ route('gaji.edit', $pegawai->id) }}"><button type="button" class="btn btn-success"><i class="bi bi-pencil"></i></button></a>
